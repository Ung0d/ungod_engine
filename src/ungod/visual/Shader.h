...
#ifndef UNGOD_SHADER_H
#define UNGOD_SHADER_H
...
namespace ungod
{
    ...
    template<>
    struct LoadBehavior<sf::Shader>
    {
        static bool loadFromFile(const std::string& filepath, sf::Shader& data);
        static std::string getIdentifier() { return "Shader"; }
    };
}

#endif // UNGOD_SHADER_H
