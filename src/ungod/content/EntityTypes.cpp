...
namespace ungod
{
    ...
    {
        world.registerInstantiation(EntityBaseComponents(), EntityOptionalComponents());
        world.registerInstantiation(ActorBaseComponents(), ActorOptionalComponents());
        world.registerInstantiation(MetaObjectBaseComponents(), MetaObjectOptionalComponents());
        world.registerInstantiation(LightBaseComponents(), LightOptionalComponents());
